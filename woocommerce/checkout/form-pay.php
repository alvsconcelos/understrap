	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'themetextdomain' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'themetextdomain' ); ?></th>
			</tr>
		</thead>
		<tbody>
